...
public class ResultController {
    ...
    private void initialize() {
        correct = QuizPageController.correctAnswers;
        wrong = QuizPageController.incorrectAnswers;

        correcttext.setText("Correct Answers : " + correct);
        wrongtext.setText("Incorrect Answers : " + String.valueOf( QuizPageController.incorrectAnswers));
